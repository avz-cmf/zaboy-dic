...
use zaboy\dic\Example\InsideConstruct\PropertiesDefault;
use zaboy\dic\Example\InsideConstruct\SettersDefault;
use zaboy\dic\Example\InsideConstruct\Inheritance;
